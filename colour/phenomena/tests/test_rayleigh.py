...
air_refraction_index_Penndorf1957` definition.
        ...
        xp_assert_close(
            air_refraction_index_Penndorf1957(xp_asarray([0.360], xp=xp)),
            1.000285316795146,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            air_refraction_index_Penndorf1957(xp_asarray([0.555], xp=xp)),
            1.000277729533864,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            air_refraction_index_Penndorf1957(xp_asarray([0.830], xp=xp)),
            1.000274856640486,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
rayleigh.air_refraction_index_Edlen1966` definition.
        ...
        xp_assert_close(
            air_refraction_index_Edlen1966(xp_asarray([0.360], xp=xp)),
            1.000285308809879,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            air_refraction_index_Edlen1966(xp_asarray([0.555], xp=xp)),
            1.000277727690364,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            air_refraction_index_Edlen1966(xp_asarray([0.830], xp=xp)),
            1.000274862218835,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
class TestAirRefractionIndexPeck1972:
    ...
    def test_air_refraction_index_Peck1972(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            air_refraction_index_Peck1972(xp_asarray([0.360], xp=xp)),
            1.000285310285056,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            air_refraction_index_Peck1972(xp_asarray([0.555], xp=xp)),
            1.000277726541484,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            air_refraction_index_Peck1972(xp_asarray([0.830], xp=xp)),
            1.000274859144804,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
air_refraction_index_Bodhaine1999` definition.
        ...
        xp_assert_close(
            air_refraction_index_Bodhaine1999(xp_asarray([0.360], xp=xp)),
            1.000285310285056,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            air_refraction_index_Bodhaine1999(xp_asarray([0.555], xp=xp)),
            1.000277726541484,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            air_refraction_index_Bodhaine1999(xp_asarray([0.830], xp=xp)),
            1.000274859144804,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            air_refraction_index_Bodhaine1999(xp_asarray([0.360], xp=xp), 0),
            1.000285264064789,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            air_refraction_index_Bodhaine1999(xp_asarray([0.555], xp=xp), 360),
            1.000277735539824,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            air_refraction_index_Bodhaine1999(xp_asarray([0.830], xp=xp), 620),
            1.000274906640464,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
class TestN2Depolarisation:
    ...
    def test_N2_depolarisation(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            N2_depolarisation(xp_asarray([0.360], xp=xp)),
            1.036445987654321,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            N2_depolarisation(xp_asarray([0.555], xp=xp)),
            1.035029137245354,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            N2_depolarisation(xp_asarray([0.830], xp=xp)),
            1.034460153868486,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
class TestO2Depolarisation:
    ...
    def test_O2_depolarisation(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            O2_depolarisation(xp_asarray([0.360], xp=xp)),
            1.115307746532541,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            O2_depolarisation(xp_asarray([0.555], xp=xp)),
            1.102022536201071,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            O2_depolarisation(xp_asarray([0.830], xp=xp)),
            1.098315561269013,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
class TestF_airPenndorf1957:
    ...
    def test_F_air_Penndorf1957(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            F_air_Penndorf1957(xp_asarray([0.360], xp=xp)),
            1.0608,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
class TestF_airYoung1981:
    ...
    def test_F_air_Young1981(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            F_air_Young1981(xp_asarray([0.360], xp=xp)),
            1.0480,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
class TestF_airBates1984:
    ...
    def test_F_air_Bates1984(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            F_air_Bates1984(xp_asarray([0.360], xp=xp)),
            1.051997277711708,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            F_air_Bates1984(xp_asarray([0.555], xp=xp)),
            1.048153579718658,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            F_air_Bates1984(xp_asarray([0.830], xp=xp)),
            1.046947068600589,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
class TestF_airBodhaine1999:
    ...
    def test_F_air_Bodhaine1999(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            F_air_Bodhaine1999(xp_asarray([0.360], xp=xp)),
            1.052659005129014,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            F_air_Bodhaine1999(xp_asarray([0.555], xp=xp)),
            1.048769718142427,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            F_air_Bodhaine1999(xp_asarray([0.830], xp=xp)),
            1.047548896943893,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            F_air_Bodhaine1999(xp_asarray([0.360], xp=xp), 0),
            1.052629792313939,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            F_air_Bodhaine1999(xp_asarray([0.555], xp=xp), 360),
            1.048775791959338,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            F_air_Bodhaine1999(xp_asarray([0.830], xp=xp), 620),
            1.047581672775155,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
class TestMolecularDensity:
    ...
    def test_molecular_density(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            molecular_density(xp_asarray([200.0], xp=xp)),
            3.669449208173649e19,
            atol=TOLERANCE_ABSOLUTE_TESTS * 1e11,
        )

        xp_assert_close(
            molecular_density(xp_asarray([300.0], xp=xp)),
            2.4462994721157665e19,
            atol=TOLERANCE_ABSOLUTE_TESTS * 1e11,
        )

        xp_assert_close(
            molecular_density(xp_asarray([400.0], xp=xp)),
    ...
    def test_n_dimensional_molecular_density(self, xp: ModuleType) -> None:
        ...
        temperature = xp.tile(xp_asarray(temperature, xp=xp), (6,))
        N_s = xp.tile(xp_asarray(N_s, xp=xp), (6,))
        xp_assert_close(
        ...
        temperature = xp_reshape(xp_asarray(temperature, xp=xp), (2, 3), xp=xp)
        N_s = xp_reshape(xp_asarray(N_s, xp=xp), (2, 3), xp=xp)
        xp_assert_close(
            molecular_density(temperature),
            N_s,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        ...
        temperature = xp_reshape(xp_asarray(temperature, xp=xp), (2, 3, 1), xp=xp)
        N_s = xp_reshape(xp_asarray(N_s, xp=xp), (2, 3, 1), xp=xp)
        xp_assert_close(
            molecular_density(temperature),
            N_s,
            atol=TOLERANCE_ABSOLUTE_TESTS,
...
class TestMeanMolecularWeights:
    ...
    def test_mean_molecular_weights(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            mean_molecular_weights(xp_asarray([0.0], xp=xp)),
            28.9595,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            mean_molecular_weights(xp_asarray([360.0], xp=xp)),
            28.964920015999997,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            mean_molecular_weights(xp_asarray([620.0], xp=xp)),
            28.968834471999998,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
    ...
    def test_n_dimensional_mean_molecular_weights(self, xp: ModuleType) -> None:
        ...
        CO2_c = xp.tile(xp_asarray(CO2_c, xp=xp), (6,))
        m_a = xp.tile(xp_asarray(m_a, xp=xp), (6,))
        xp_assert_close(
        ...
        CO2_c = xp_reshape(xp_asarray(CO2_c, xp=xp), (2, 3), xp=xp)
        m_a = xp_reshape(xp_asarray(m_a, xp=xp), (2, 3), xp=xp)
        xp_assert_close(
            mean_molecular_weights(CO2_c),
            m_a,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        ...
        CO2_c = xp_reshape(xp_asarray(CO2_c, xp=xp), (2, 3, 1), xp=xp)
        m_a = xp_reshape(xp_asarray(m_a, xp=xp), (2, 3, 1), xp=xp)
        xp_assert_close(
            mean_molecular_weights(CO2_c),
            m_a,
            atol=TOLERANCE_ABSOLUTE_TESTS,
...
class TestGravityList1968:
    ...
    def test_gravity_List1968(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            gravity_List1968(xp_asarray([0.0], xp=xp), xp_asarray([0.0], xp=xp)),
            978.03560706,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            gravity_List1968(xp_asarray([45.0], xp=xp), xp_asarray([1500.0], xp=xp)),
            980.15334386,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            gravity_List1968(xp_asarray([48.8567], xp=xp), xp_asarray([35.0], xp=xp)),
            980.95241784,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
class TestScatteringCrossSection:
    ...
    def test_scattering_cross_section(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            scattering_cross_section(xp_asarray([360 * 10e-8], xp=xp)),
            2.600908533851937e-26,
            atol=TOLERANCE_ABSOLUTE_TESTS * 1e-23,
        )

        xp_assert_close(
            scattering_cross_section(xp_asarray([555 * 10e-8], xp=xp)),
            4.346669248087624e-27,
            atol=TOLERANCE_ABSOLUTE_TESTS * 1e-23,
        )

        xp_assert_close(
            scattering_cross_section(xp_asarray([830 * 10e-8], xp=xp)),
            8.501515434751428e-28,
            atol=TOLERANCE_ABSOLUTE_TESTS * 1e-23,
        )

        xp_assert_close(
            scattering_cross_section(xp_asarray([555 * 10e-8], xp=xp), 0),
            4.346543336839102e-27,
            atol=TOLERANCE_ABSOLUTE_TESTS * 1e-23,
        )

        xp_assert_close(
            scattering_cross_section(xp_asarray([555 * 10e-8], xp=xp), 360),
            4.346694421271718e-27,
            atol=TOLERANCE_ABSOLUTE_TESTS * 1e-23,
        )

        xp_assert_close(
            scattering_cross_section(xp_asarray([555 * 10e-8], xp=xp), 620),
            4.346803470171720e-27,
            atol=TOLERANCE_ABSOLUTE_TESTS * 1e-23,
        )

        xp_assert_close(
            scattering_cross_section(xp_asarray([555 * 10e-8], xp=xp), temperature=200),
            2.094012829135068e-27,
            atol=TOLERANCE_ABSOLUTE_TESTS * 1e-23,
        )

        xp_assert_close(
            scattering_cross_section(xp_asarray([555 * 10e-8], xp=xp), temperature=300),
            4.711528865553901e-27,
            atol=TOLERANCE_ABSOLUTE_TESTS * 1e-23,
        )

        xp_assert_close(
            scattering_cross_section(xp_asarray([555 * 10e-8], xp=xp), temperature=400),
...
class TestRayleighOpticalDepth:
    ...
    def test_rayleigh_optical_depth(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            rayleigh_optical_depth(xp_asarray([360 * 10e-8], xp=xp)),
            0.560246579231107,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            rayleigh_optical_depth(xp_asarray([555 * 10e-8], xp=xp)),
            0.093629074056042,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            rayleigh_optical_depth(xp_asarray([830 * 10e-8], xp=xp)),
            0.018312619911882,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            rayleigh_optical_depth(xp_asarray([555 * 10e-8], xp=xp), 0),
            0.093640964348049,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            rayleigh_optical_depth(xp_asarray([555 * 10e-8], xp=xp), 360),
            0.093626696247360,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            rayleigh_optical_depth(xp_asarray([555 * 10e-8], xp=xp), 620),
            0.093616393371777,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            rayleigh_optical_depth(xp_asarray([555 * 10e-8], xp=xp), temperature=200),
            0.045105912380991,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            rayleigh_optical_depth(xp_asarray([555 * 10e-8], xp=xp), temperature=300),
            0.101488302857230,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            rayleigh_optical_depth(xp_asarray([555 * 10e-8], xp=xp), temperature=400),
            0.180423649523964,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            rayleigh_optical_depth(xp_asarray([555 * 10e-8], xp=xp), pressure=101325),
            0.093629074056042,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            rayleigh_optical_depth(xp_asarray([555 * 10e-8], xp=xp), pressure=100325),
            0.092705026939772,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            rayleigh_optical_depth(xp_asarray([555 * 10e-8], xp=xp), pressure=99325),
            0.091780979823502,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            rayleigh_optical_depth(
                xp_asarray([555 * 10e-8], xp=xp), latitude=0, altitude=0
            ),
            0.093629074056041,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
