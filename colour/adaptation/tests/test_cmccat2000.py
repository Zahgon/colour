...
chromatic_adaptation_forward_CMCCAT2000` definition.
        ...
        xp_assert_close(
            chromatic_adaptation_forward_CMCCAT2000(
                xp_asarray([22.48, 22.74, 8.54], xp=xp),
                xp_asarray([111.15, 100.00, 35.20], xp=xp),
                xp_asarray([94.81, 100.00, 107.30], xp=xp),
                200,
                200,
            ),
        ...
        xp_assert_close(
            chromatic_adaptation_forward_CMCCAT2000(
                ...
                xp_asarray([0.95045593, 1.00000000, 1.08905775], xp=xp) * 100,
                xp_asarray([1.09846607, 1.00000000, 0.35582280], xp=xp) * 100,
                100,
                100,
            ),
        ...
        xp_assert_close(
            chromatic_adaptation_forward_CMCCAT2000(
                ...
                xp_asarray([0.95045593, 1.00000000, 1.08905775], xp=xp) * 100,
                xp_asarray([0.99144661, 1.00000000, 0.67315942], xp=xp) * 100,
                100,
                100,
            ),
...
chromatic_adaptation_forward_CMCCAT2000` definition n-dimensional arrays
        ...
        XYZ = xp_asarray([22.48, 22.74, 8.54], xp=xp)
        XYZ_w = xp_asarray([111.15, 100.00, 35.20], xp=xp)
        XYZ_wr = xp_asarray([94.81, 100.00, 107.30], xp=xp)
        L_A1 = 200
        L_A2 = 200
        XYZ_c = np.asarray(
        ...
        XYZ_c = xp.tile(xp_asarray(XYZ_c, xp=xp), (6, 1))
        xp_assert_close(
            chromatic_adaptation_forward_CMCCAT2000(XYZ, XYZ_w, XYZ_wr, L_A1, L_A2),
            XYZ_c,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        ...
        XYZ_wr = xp.tile(xp_asarray(XYZ_wr, xp=xp), (6, 1))
        L_A1 = xp.tile(xp_asarray(L_A1, xp=xp), (6,))
        L_A2 = xp.tile(xp_asarray(L_A2, xp=xp), (6,))
        xp_assert_close(
            chromatic_adaptation_forward_CMCCAT2000(XYZ, XYZ_w, XYZ_wr, L_A1, L_A2),
            XYZ_c,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        ...
        XYZ_wr = xp_reshape(xp_asarray(XYZ_wr, xp=xp), (2, 3, 3), xp=xp)
        L_A1 = xp_reshape(xp_asarray(L_A1, xp=xp), (2, 3), xp=xp)
        L_A2 = xp_reshape(xp_asarray(L_A2, xp=xp), (2, 3), xp=xp)
        XYZ_c = xp_reshape(xp_asarray(XYZ_c, xp=xp), (2, 3, 3), xp=xp)
        xp_assert_close(
            chromatic_adaptation_forward_CMCCAT2000(XYZ, XYZ_w, XYZ_wr, L_A1, L_A2),
            XYZ_c,
            atol=TOLERANCE_ABSOLUTE_TESTS,
...
chromatic_adaptation_inverse_CMCCAT2000` definition.
        ...
        xp_assert_close(
            chromatic_adaptation_inverse_CMCCAT2000(
                xp_asarray([19.52698326, 23.06833960, 24.97175229], xp=xp),
                xp_asarray([111.15, 100.00, 35.20], xp=xp),
                xp_asarray([94.81, 100.00, 107.30], xp=xp),
                200,
                200,
        ...
        xp_assert_close(
            chromatic_adaptation_inverse_CMCCAT2000(
                xp_asarray([17.90511171, 22.75299363, 3.79837384], xp=xp),
                xp_asarray([0.95045593, 1.00000000, 1.08905775], xp=xp) * 100,
                xp_asarray([1.09846607, 1.00000000, 0.35582280], xp=xp) * 100,
                100,
                100,
        ...
        xp_assert_close(
            chromatic_adaptation_inverse_CMCCAT2000(
                xp_asarray([6.76564344, 5.86585763, 18.40577315], xp=xp),
                xp_asarray([0.95045593, 1.00000000, 1.08905775], xp=xp) * 100,
                xp_asarray([0.99144661, 1.00000000, 0.67315942], xp=xp) * 100,
                100,
                100,
...
chromatic_adaptation_inverse_CMCCAT2000` definition n-dimensional arrays
        ...
        XYZ_c = xp_asarray([19.52698326, 23.06833960, 24.97175229], xp=xp)
        XYZ_w = xp_asarray([111.15, 100.00, 35.20], xp=xp)
        XYZ_wr = xp_asarray([94.81, 100.00, 107.30], xp=xp)
        L_A1 = 200
        L_A2 = 200
