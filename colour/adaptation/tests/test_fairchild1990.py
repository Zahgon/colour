...
chromatic_adaptation_Fairchild1990` definition.
        ...
        xp_assert_close(
            chromatic_adaptation_Fairchild1990(
                xp_asarray([19.53, 23.07, 24.97], xp=xp),
...
chromatic_adaptation_Fairchild1990` definition n-dimensional arrays support.
        ...
        XYZ_1 = xp_asarray([19.53, 23.07, 24.97], xp=xp)
        XYZ_n = xp_asarray([111.15, 100.00, 35.20], xp=xp)
        XYZ_r = xp_asarray([94.81, 100.00, 107.30], xp=xp)
        Y_n = 200
        XYZ_c = np.asarray(chromatic_adaptation_Fairchild1990(XYZ_1, XYZ_n, XYZ_r, Y_n))
        ...
        XYZ_r = xp.tile(xp_asarray(XYZ_r, xp=xp), (6, 1))
        Y_n = xp.tile(xp_asarray(Y_n, xp=xp), (6,))
        xp_assert_close(
            chromatic_adaptation_Fairchild1990(XYZ_1, XYZ_n, XYZ_r, Y_n),
            XYZ_c,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        ...
        XYZ_r = xp_reshape(xp_asarray(XYZ_r, xp=xp), (2, 3, 3), xp=xp)
        Y_n = xp_reshape(xp_asarray(Y_n, xp=xp), (2, 3), xp=xp)
