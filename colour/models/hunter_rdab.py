...
def XYZ_to_Hunter_Rdab(
    ...
    X_n = xp_asarray(X_n, xp=xp, like=XYZ)
    Y_n = xp_asarray(Y_n, xp=xp, like=XYZ)
    Z_n = xp_asarray(Z_n, xp=xp, like=XYZ)
    K_a = xp_asarray(K_a, xp=xp, like=XYZ)
    K_b = xp_asarray(K_b, xp=xp, like=XYZ)
...
def Hunter_Rdab_to_XYZ(
    ...
    X_n = xp_asarray(X_n, xp=xp, like=R_d_ab)
    Y_n = xp_asarray(Y_n, xp=xp, like=R_d_ab)
    Z_n = xp_asarray(Z_n, xp=xp, like=R_d_ab)
    K_a = xp_asarray(K_a, xp=xp, like=R_d_ab)
    K_b = xp_asarray(K_b, xp=xp, like=R_d_ab)
