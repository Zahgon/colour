...
class TestRGB_to_CMY:
    ...
    def test_RGB_to_CMY(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            RGB_to_CMY(xp_asarray([0.45620519, 0.03081071, 0.04091952], xp=xp)),
            np.array([0.54379481, 0.96918929, 0.95908048]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            RGB_to_CMY(xp_asarray([0.00000000, 0.00000000, 0.00000000], xp=xp)),
            np.array([1.00000000, 1.00000000, 1.00000000]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            RGB_to_CMY(xp_asarray([1.00000000, 1.00000000, 1.00000000], xp=xp)),
...
class TestCMY_to_RGB:
    ...
    def test_CMY_to_RGB(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            CMY_to_RGB(xp_asarray([0.54379481, 0.96918929, 0.95908048], xp=xp)),
            np.array([0.45620519, 0.03081071, 0.04091952]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            CMY_to_RGB(xp_asarray([1.00000000, 1.00000000, 1.00000000], xp=xp)),
            np.array([0.00000000, 0.00000000, 0.00000000]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            CMY_to_RGB(xp_asarray([0.00000000, 0.00000000, 0.00000000], xp=xp)),
            np.array([1.00000000, 1.00000000, 1.00000000]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
    ...
    def test_n_dimensional_CMY_to_RGB(self, xp: ModuleType) -> None:
        ...
        CMY = xp_asarray([0.54379481, 0.96918929, 0.95908048], xp=xp)
        RGB = np.asarray(CMY_to_RGB(CMY))
...
class TestCMY_to_CMYK:
    ...
    def test_CMY_to_CMYK(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            CMY_to_CMYK(xp_asarray([0.54379481, 0.96918929, 0.95908048], xp=xp)),
            np.array([0.00000000, 0.93246304, 0.91030457, 0.54379481]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            CMY_to_CMYK(xp_asarray([0.15000000, 1.00000000, 1.00000000], xp=xp)),
            np.array([0.00000000, 1.00000000, 1.00000000, 0.15000000]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            CMY_to_CMYK(xp_asarray([0.15000000, 0.00000000, 0.00000000], xp=xp)),
    ...
    def test_n_dimensional_CMY_to_CMYK(self, xp: ModuleType) -> None:
        ...
        CMY = xp_asarray([0.54379481, 0.96918929, 0.95908048], xp=xp)
        CMYK = np.asarray(CMY_to_CMYK(CMY))

        CMY = xp.tile(xp_asarray(CMY, xp=xp), (6, 1))
        CMYK = xp.tile(xp_asarray(CMYK, xp=xp), (6, 1))
        xp_assert_close(CMY_to_CMYK(CMY), CMYK, atol=TOLERANCE_ABSOLUTE_TESTS)

        CMY = xp_reshape(xp_asarray(CMY, xp=xp), (2, 3, 3), xp=xp)
        CMYK = xp_reshape(xp_asarray(CMYK, xp=xp), (2, 3, 4), xp=xp)
        xp_assert_close(CMY_to_CMYK(CMY), CMYK, atol=TOLERANCE_ABSOLUTE_TESTS)
...
class TestCMYK_to_CMY:
    ...
    def test_CMYK_to_CMY(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            CMYK_to_CMY(
                xp_asarray([0.00000000, 0.93246304, 0.91030457, 0.54379481], xp=xp)
            ),
            np.array([0.54379481, 0.96918929, 0.95908048]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            CMYK_to_CMY(
                xp_asarray([0.00000000, 1.00000000, 1.00000000, 0.15000000], xp=xp)
            ),
        ...
        xp_assert_close(
            CMYK_to_CMY(
                xp_asarray([0.15000000, 0.00000000, 0.00000000, 0.00000000], xp=xp)
            ),
    ...
    def test_n_dimensional_CMYK_to_CMY(self, xp: ModuleType) -> None:
        ...
        CMYK = xp_asarray([0.00000000, 0.93246304, 0.91030457, 0.54379481], xp=xp)
        CMY = np.asarray(CMYK_to_CMY(CMYK))
