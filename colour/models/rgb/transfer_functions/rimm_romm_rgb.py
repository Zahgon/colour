...
def log_encoding_ERIMMRGB(
    ...
    E_t = xp.exp(xp_asarray(1.0, xp=xp)) * E_min

    l_E_t = xp.log(xp_asarray(E_t, xp=xp))
    l_E_min = xp.log(xp_asarray(float(E_min), xp=xp))
    l_E_clip = xp.log(xp_asarray(float(E_clip), xp=xp))
