...
def log_encoding_FLog(
    ...
    >>> np.round(log_encoding_FLog(x, 10, False) * 100, 1)
    array([ 3.5, 46.3, 73.2])
    >>> np.round(log_encoding_FLog(x) * (2**10 - 1)).astype(np.int_)
    array([ 95, 470, 705])
    """
...
def log_encoding_FLog2(
    ...
    >>> x = np.array([0, 18, 90]) / 100
    >>> np.round(log_encoding_FLog2(x, 10, False) * 100, 1)
    array([ 3.5, 38.4, 57.8])
    >>> np.round(log_encoding_FLog2(x) * (2**10 - 1)).astype(np.int_)
    array([ 95, 400, 570])
    """
