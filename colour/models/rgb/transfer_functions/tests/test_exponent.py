...
exponent_function_basic` definition.
        ...
        a_p = 0.0229932049927
        xp_assert_close(
            exponent_function_basic(xp_asarray(a, xp=xp), 2.2),
            a_p,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            exponent_function_basic(xp_asarray(a, xp=xp), 2.2, "basicMirrorFwd"),
            a_p,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            exponent_function_basic(xp_asarray(a, xp=xp), 2.2, "basicPassThruFwd"),
            a_p,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        a_p = 0.18
        xp_assert_close(
            exponent_function_basic(xp_asarray(a, xp=xp), 2.2, "basicRev"),
            a_p,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            exponent_function_basic(xp_asarray(a, xp=xp), 2.2, "basicMirrorRev"),
            a_p,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            exponent_function_basic(xp_asarray(a, xp=xp), 2.2, "basicPassThruRev"),
            a_p,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
exponent_function_monitor_curve` definition.
        ...
        a_p = 0.0232240466001
        xp_assert_close(
            exponent_function_monitor_curve(xp_asarray(a, xp=xp), 2.2, 0.001),
            a_p,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            exponent_function_monitor_curve(
                xp_asarray(a, xp=xp), 2.2, 0.001, "monCurveMirrorFwd"
            ),
            a_p,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            exponent_function_monitor_curve(
                xp_asarray(a, xp=xp), 2.2, 0.001, "monCurveRev"
            ),
            a_p,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            exponent_function_monitor_curve(
                xp_asarray(a, xp=xp), 2.2, 0.001, "monCurveMirrorRev"
            ),
            a_p,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
