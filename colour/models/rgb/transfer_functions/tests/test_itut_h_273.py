...
oetf_H273_Log` definition.
        ...
        xp_assert_close(
            oetf_H273_Log(xp_asarray(0.0, xp=xp)),
            0.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            oetf_H273_Log(xp_asarray(0.18, xp=xp)),
            0.627636252551653,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            oetf_H273_Log(xp_asarray(1.0, xp=xp)),
            1.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
oetf_H273_Log` definition n-dimensional arrays support.
        ...
        E = 0.18
        E_p = np.asarray(oetf_H273_Log(xp_asarray(E, xp=xp)))
...
oetf_H273_Log` definition domain and range scale support.
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    oetf_H273_Log(xp_asarray(E * factor, xp=xp)),
                    E_p * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
oetf_inverse_H273_Log` definition.
        ...
        # properly.
        xp_assert_close(
            oetf_inverse_H273_Log(xp_asarray(0.0, xp=xp)),
            0.01,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            oetf_inverse_H273_Log(xp_asarray(0.627636252551653, xp=xp)),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            oetf_inverse_H273_Log(xp_asarray(1.0, xp=xp)),
            1.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
oetf_inverse_H273_Log` definition n-dimensional arrays support.
        ...
        E = np.asarray(oetf_inverse_H273_Log(xp_asarray(E_p, xp=xp)))
...
oetf_inverse_H273_Log` definition domain and range scale support.
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    oetf_inverse_H273_Log(xp_asarray(E_p * factor, xp=xp)),
                    E * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
oetf_H273_LogSqrt` definition.
        ...
        xp_assert_close(
            oetf_H273_LogSqrt(xp_asarray(0.0, xp=xp)),
            0.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            oetf_H273_LogSqrt(xp_asarray(0.18, xp=xp)),
            0.702109002041322,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            oetf_H273_LogSqrt(xp_asarray(1.0, xp=xp)),
            1.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
oetf_H273_LogSqrt` definition n-dimensional arrays support.
        ...
        E = 0.18
        E_p = np.asarray(oetf_H273_LogSqrt(xp_asarray(E, xp=xp)))
...
oetf_H273_LogSqrt` definition domain and range scale support.
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    oetf_H273_LogSqrt(xp_asarray(E * factor, xp=xp)),
                    E_p * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
oetf_inverse_H273_LogSqrt` definition.
        ...
        # properly.
        xp_assert_close(
            oetf_inverse_H273_LogSqrt(xp_asarray(0.0, xp=xp)),
            0.003162277660168,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            oetf_inverse_H273_LogSqrt(xp_asarray(0.702109002041322, xp=xp)),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            oetf_inverse_H273_LogSqrt(xp_asarray(1.0, xp=xp)),
            1.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
oetf_inverse_H273_LogSqrt` definition n-dimensional arrays support.
        ...
        E = np.asarray(oetf_inverse_H273_LogSqrt(xp_asarray(E_p, xp=xp)))
...
oetf_inverse_H273_LogSqrt` definition domain and range scale support.
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    oetf_inverse_H273_LogSqrt(xp_asarray(E_p * factor, xp=xp)),
                    E * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
oetf_H273_IEC61966_2` definition.
        ...
        xp_assert_close(
            oetf_H273_IEC61966_2(xp_asarray(-0.18, xp=xp)),
            -0.461356129500442,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            oetf_H273_IEC61966_2(xp_asarray(0.0, xp=xp)),
            0.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            oetf_H273_IEC61966_2(xp_asarray(1.0, xp=xp)),
            1.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
oetf_H273_IEC61966_2` definition n-dimensional arrays support.
        ...
        E = 0.18
        E_p = np.asarray(oetf_H273_IEC61966_2(xp_asarray(E, xp=xp)))
...
oetf_H273_IEC61966_2` definition domain and range scale support.
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    oetf_H273_IEC61966_2(xp_asarray(E * factor, xp=xp)),
                    E_p * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
oetf_inverse_H273_IEC61966_2` definition.
        ...
        xp_assert_close(
            oetf_inverse_H273_IEC61966_2(xp_asarray(-0.461356129500442, xp=xp)),
            -0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            oetf_inverse_H273_IEC61966_2(xp_asarray(0.0, xp=xp)),
            0.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            oetf_inverse_H273_IEC61966_2(xp_asarray(1.0, xp=xp)),
            1.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
oetf_inverse_H273_IEC61966_2` definition n-dimensional arrays support.
        ...
        E_p = 0.627636252551653
        E = np.asarray(oetf_inverse_H273_IEC61966_2(xp_asarray(E_p, xp=xp)))
...
oetf_inverse_H273_IEC61966_2` definition domain and range scale support.
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    oetf_inverse_H273_IEC61966_2(xp_asarray(E_p * factor, xp=xp)),
                    E * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
eotf_inverse_H273_ST428_1` definition.
        ...
        xp_assert_close(
            eotf_inverse_H273_ST428_1(xp_asarray(0.0, xp=xp)),
            0.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            eotf_inverse_H273_ST428_1(xp_asarray(0.18, xp=xp)),
            0.500048337717236,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            eotf_inverse_H273_ST428_1(xp_asarray(1.0, xp=xp)),
            0.967042675317934,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
eotf_inverse_H273_ST428_1` definition n-dimensional arrays support.
        ...
        E = 0.18
        E_p = np.asarray(eotf_inverse_H273_ST428_1(xp_asarray(E, xp=xp)))
...
eotf_inverse_H273_ST428_1` definition domain and range scale support.
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    eotf_inverse_H273_ST428_1(xp_asarray(E * factor, xp=xp)),
                    E_p * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
eotf_H273_ST428_1` definition.
        ...
        xp_assert_close(
            eotf_H273_ST428_1(xp_asarray(0.0, xp=xp)),
            0.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            eotf_H273_ST428_1(xp_asarray(0.500048337717236, xp=xp)),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            eotf_H273_ST428_1(xp_asarray(0.967042675317934, xp=xp)),
            1.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
eotf_H273_ST428_1` definition n-dimensional arrays support.
        ...
        E = np.asarray(eotf_H273_ST428_1(xp_asarray(E_p, xp=xp)))
...
eotf_H273_ST428_1` definition domain and range scale support.
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    eotf_H273_ST428_1(xp_asarray(E_p * factor, xp=xp)),
                    E * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
