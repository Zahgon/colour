...
logarithmic_function_basic` definition.
        ...
        xp_assert_close(
            logarithmic_function_basic(xp_asarray(0.18, xp=xp)),
            -2.473931188332412,
        ...
        xp_assert_close(
            logarithmic_function_basic(
                xp_asarray(-2.473931188332412, xp=xp), "antiLog2"
            ),
            0.180000000000000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_basic(xp_asarray(0.18, xp=xp), "log10"),
            -0.744727494896694,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_basic(
                xp_asarray(-0.744727494896694, xp=xp), "antiLog10"
            ),
            0.179999999999999,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_basic(xp_asarray(0.18, xp=xp), "logB", 3),
            -1.560876795007312,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_basic(
                xp_asarray(-1.560876795007312, xp=xp), "antiLogB", 3
            ),
            0.180000000000000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
logarithmic_function_basic` definition n-dimensional arrays support.
        ...
        for style in styles:
            a = 0.18
            a_p = np.asarray(logarithmic_function_basic(xp_asarray(a, xp=xp), style))

            a = xp.tile(xp_asarray(a, xp=xp), (6,))
            a_p = xp.tile(xp_asarray(a_p, xp=xp), (6,))
            xp_assert_close(
            ...
            a = xp_reshape(xp_asarray(a, xp=xp), (2, 3), xp=xp)
            a_p = xp_reshape(xp_asarray(a_p, xp=xp), (2, 3), xp=xp)
            xp_assert_close(
                logarithmic_function_basic(a, style),
                a_p,
                atol=TOLERANCE_ABSOLUTE_TESTS,
            ...
            a = xp_reshape(xp_asarray(a, xp=xp), (2, 3, 1), xp=xp)
            a_p = xp_reshape(xp_asarray(a_p, xp=xp), (2, 3, 1), xp=xp)
            xp_assert_close(
                logarithmic_function_basic(a, style),
                a_p,
                atol=TOLERANCE_ABSOLUTE_TESTS,
...
logarithmic_function_quasilog` definition.
        ...
        xp_assert_close(
            logarithmic_function_quasilog(xp_asarray(0.18, xp=xp)),
            -2.473931188332412,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_quasilog(
                xp_asarray(-2.473931188332412, xp=xp), "logToLin"
            ),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_quasilog(xp_asarray(0.18, xp=xp), "linToLog", 10),
            -0.744727494896694,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_quasilog(
                xp_asarray(-0.744727494896694, xp=xp), "logToLin", 10
            ),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_quasilog(
                xp_asarray(0.18, xp=xp), "linToLog", 10, 0.75
            ),
            -0.558545621172520,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_quasilog(
                xp_asarray(-0.558545621172520, xp=xp), "logToLin", 10, 0.75
            ),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_quasilog(
                xp_asarray(0.18, xp=xp), "linToLog", 10, 0.75, 0.75
            ),
            -0.652249673628745,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_quasilog(
                xp_asarray(0.18, xp=xp), "linToLog", 10, 0.75, 0.75, 0.001
            ),
            -0.651249673628745,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
logarithmic_function_quasilog` definition n-dimensional arrays support.
        ...
        for style in styles:
            a = 0.18
            a_p = np.asarray(logarithmic_function_quasilog(xp_asarray(a, xp=xp), style))
...
logarithmic_function_camera` definition.
        ...
        xp_assert_close(
            logarithmic_function_camera(xp_asarray(0, xp=xp), "cameraLinToLog"),
            -9.08655123066369,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_camera(
                xp_asarray(-9.08655123066369, xp=xp), "cameraLogToLin"
            ),
            0.000000000000000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_camera(xp_asarray(0.18, xp=xp), "cameraLinToLog"),
            -2.473931188332412,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_camera(
                xp_asarray(-2.473931188332412, xp=xp), "cameraLogToLin"
            ),
            0.180000000000000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_camera(xp_asarray(1, xp=xp), "cameraLinToLog"),
            0.000000000000000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            logarithmic_function_camera(xp_asarray(0, xp=xp), "cameraLogToLin"),
            1.000000000000000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            logarithmic_function_camera(xp_asarray(0.18, xp=xp), "cameraLinToLog", 10),
            -0.744727494896693,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_camera(
                xp_asarray(-0.744727494896693, xp=xp), "cameraLogToLin", 10
            ),
            0.180000000000000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_camera(
                xp_asarray(0.18, xp=xp), "cameraLinToLog", 10, 0.25
            ),
            -0.186181873724173,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_camera(
                xp_asarray(-0.186181873724173, xp=xp), "cameraLogToLin", 10, 0.25
            ),
            0.180000000000000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_camera(
                xp_asarray(0.18, xp=xp), "cameraLinToLog", 10, 0.25, 0.95
            ),
            -0.191750972401961,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            logarithmic_function_camera(
                xp_asarray(0.18, xp=xp), "cameraLinToLog", 10, 0.25, 0.95, 0.6
            ),
            0.408249027598038,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
logarithmic_function_camera` definition n-dimensional arrays support.
        ...
        for style in styles:
            a = 0.18
            a_p = np.asarray(logarithmic_function_camera(xp_asarray(a, xp=xp), style))
...
log_encoding_Log2` definition.
        ...
        xp_assert_close(
            log_encoding_Log2(xp_asarray(0.0, xp=xp)),
            -np.inf,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_Log2(xp_asarray(0.18, xp=xp)),
            0.5,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_Log2(xp_asarray(1.0, xp=xp)),
            0.690302399102493,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_Log2(xp_asarray(0.18, xp=xp), 0.12),
            0.544997115440089,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_Log2(xp_asarray(0.18, xp=xp), 0.12, 2**-10),
            0.089857490719529,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_Log2(xp_asarray(0.18, xp=xp), 0.12, 2**-10, 2**10),
            0.000570299311674,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
log_encoding_Log2` definition n-dimensional arrays support.
        ...
        x = 0.18
        y = np.asarray(log_encoding_Log2(xp_asarray(x, xp=xp)))
...
log_decoding_Log2` definition.
        ...
        xp_assert_close(
            log_decoding_Log2(xp_asarray(0.0, xp=xp)),
            0.001988737822087,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_Log2(xp_asarray(0.5, xp=xp)),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_Log2(xp_asarray(0.690302399102493, xp=xp)),
            1.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_Log2(xp_asarray(0.544997115440089, xp=xp), 0.12),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_Log2(xp_asarray(0.089857490719529, xp=xp), 0.12, 2**-10),
            0.180000000000000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_Log2(
                xp_asarray(0.000570299311674, xp=xp), 0.12, 2**-10, 2**10
            ),
            0.180000000000000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
log_decoding_Log2` definition n-dimensional arrays support.
        ...
        y = 0.5
        x = np.asarray(log_decoding_Log2(xp_asarray(y, xp=xp)))
