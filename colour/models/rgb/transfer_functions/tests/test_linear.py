...
linear_function` definition.
        ...
        assert np.asarray(linear_function(xp_asarray(0.0, xp=xp))) == 0.0

        assert np.asarray(linear_function(xp_asarray(0.18, xp=xp))) == 0.18

        assert np.asarray(linear_function(xp_asarray(1.0, xp=xp))) == 1.0
...
linear_function` definition n-dimensional arrays support.
        ...
        a = 0.18
        a_p = np.asarray(linear_function(xp_asarray(a, xp=xp)))
