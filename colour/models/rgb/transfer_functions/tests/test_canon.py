...
log_encoding_CanonLog_v1` definition.
        ...
        xp_assert_close(
            log_encoding_CanonLog_v1(xp_asarray(-0.1, xp=xp)),
            -0.023560122781997,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog_v1(xp_asarray(0.0, xp=xp)),
            0.125122480156403,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog_v1(xp_asarray(0.18, xp=xp)),
            0.343389651726069,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog_v1(xp_asarray(0.18, xp=xp), 12),
            0.343138084215647,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog_v1(xp_asarray(0.18, xp=xp), 10, False),
            0.327953896935809,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog_v1(xp_asarray(0.18, xp=xp), 10, False, False),
            0.312012855550395,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog_v1(xp_asarray(1.0, xp=xp)),
            0.618775485598649,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
log_encoding_CanonLog_v1` definition n-dimensional arrays support.
        ...
        x = 0.18
        clog = np.asarray(log_encoding_CanonLog_v1(xp_asarray(x, xp=xp)))

        x = xp.tile(xp_asarray(x, xp=xp), (6,))
        clog = xp.tile(xp_asarray(clog, xp=xp), (6,))
        xp_assert_close(
            log_encoding_CanonLog_v1(x), clog, atol=TOLERANCE_ABSOLUTE_TESTS
        )

        x = xp_reshape(xp_asarray(x, xp=xp), (2, 3), xp=xp)
        clog = xp_reshape(xp_asarray(clog, xp=xp), (2, 3), xp=xp)
        xp_assert_close(
            log_encoding_CanonLog_v1(x), clog, atol=TOLERANCE_ABSOLUTE_TESTS
        )

        x = xp_reshape(xp_asarray(x, xp=xp), (2, 3, 1), xp=xp)
        clog = xp_reshape(xp_asarray(clog, xp=xp), (2, 3, 1), xp=xp)
        xp_assert_close(
            log_encoding_CanonLog_v1(x), clog, atol=TOLERANCE_ABSOLUTE_TESTS
        )
...
log_encoding_CanonLog_v1` definition domain and range scale support.
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    log_encoding_CanonLog_v1(xp_asarray(x * factor, xp=xp)),
                    clog * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
log_decoding_CanonLog_v1` definition.
        ...
        xp_assert_close(
            log_decoding_CanonLog_v1(xp_asarray(-0.023560122781997, xp=xp)),
            -0.1,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog_v1(xp_asarray(0.125122480156403, xp=xp)),
            0.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog_v1(xp_asarray(0.343389651726069, xp=xp)),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog_v1(xp_asarray(0.343138084215647, xp=xp), 12),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog_v1(xp_asarray(0.327953896935809, xp=xp), 10, False),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog_v1(
                xp_asarray(0.312012855550395, xp=xp), 10, False, False
            ),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog_v1(xp_asarray(0.618775485598649, xp=xp)),
            1.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
log_decoding_CanonLog_v1` definition n-dimensional arrays support.
        ...
        x = np.asarray(log_decoding_CanonLog_v1(xp_asarray(clog, xp=xp)))
...
log_decoding_CanonLog_v1` definition domain and range scale support.
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    log_decoding_CanonLog_v1(xp_asarray(clog * factor, xp=xp)),
                    x * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
log_encoding_CanonLog_v1_2` definition.
        ...
        xp_assert_close(
            log_encoding_CanonLog_v1_2(xp_asarray(-0.1, xp=xp)),
            -0.023560121389098,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog_v1_2(xp_asarray(0.0, xp=xp)),
            0.125122480000000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog_v1_2(xp_asarray(0.18, xp=xp)),
            0.343389649295280,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog_v1_2(xp_asarray(0.18, xp=xp), 12),
            0.343389649295281,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog_v1_2(xp_asarray(0.18, xp=xp), 10, False),
            0.327953894097114,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog_v1_2(xp_asarray(0.18, xp=xp), 10, False, False),
            0.312012852877809,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog_v1_2(xp_asarray(1.0, xp=xp)),
            0.618775480298287,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_encoding_CanonLog_v1(xp_asarray(samples, xp=xp)),
            np.asarray(log_encoding_CanonLog_v1_2(xp_asarray(samples, xp=xp))),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_encoding_CanonLog_v1(
                xp_asarray(samples, xp=xp), out_normalised_code_value=False
            ),
            np.asarray(
                log_encoding_CanonLog_v1_2(
                    xp_asarray(samples, xp=xp), out_normalised_code_value=False
        ...
        xp_assert_close(
            log_encoding_CanonLog_v1(xp_asarray(samples, xp=xp), in_reflection=False),
            np.asarray(
                log_encoding_CanonLog_v1_2(
                    xp_asarray(samples, xp=xp), in_reflection=False
                )
            ),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
log_encoding_CanonLog_v1_2` definition n-dimensional arrays support.
        ...
        x = 0.18
        clog = np.asarray(log_encoding_CanonLog_v1_2(xp_asarray(x, xp=xp)))
...
log_encoding_CanonLog_v1_2` definition domain and range scale support.
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    log_encoding_CanonLog_v1_2(xp_asarray(x * factor, xp=xp)),
                    clog * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
log_decoding_CanonLog_v1_2` definition.
        ...
        xp_assert_close(
            log_decoding_CanonLog_v1_2(xp_asarray(-0.023560121389098, xp=xp)),
            -0.1,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog_v1_2(xp_asarray(0.125122480000000, xp=xp)),
            0.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog_v1_2(xp_asarray(0.343389649295280, xp=xp)),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog_v1_2(xp_asarray(0.343389649295281, xp=xp), 12),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog_v1_2(xp_asarray(0.327953894097114, xp=xp), 10, False),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog_v1_2(
                xp_asarray(0.312012852877809, xp=xp), 10, False, False
            ),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog_v1_2(xp_asarray(0.618775480298287, xp=xp)),
            1.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog_v1(xp_asarray(samples, xp=xp)),
            np.asarray(log_decoding_CanonLog_v1_2(xp_asarray(samples, xp=xp))),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog_v1(
                xp_asarray(samples, xp=xp), in_normalised_code_value=False
            ),
            np.asarray(
                log_decoding_CanonLog_v1_2(
                    xp_asarray(samples, xp=xp), in_normalised_code_value=False
        ...
        xp_assert_close(
            log_decoding_CanonLog_v1(xp_asarray(samples, xp=xp), out_reflection=False),
            np.asarray(
                log_decoding_CanonLog_v1_2(
                    xp_asarray(samples, xp=xp), out_reflection=False
                )
            ),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
log_decoding_CanonLog_v1_2` definition n-dimensional arrays support.
        ...
        x = np.asarray(log_decoding_CanonLog_v1_2(xp_asarray(clog, xp=xp)))
...
log_decoding_CanonLog_v1_2` definition domain and range scale support.
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    log_decoding_CanonLog_v1_2(xp_asarray(clog * factor, xp=xp)),
                    x * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
log_encoding_CanonLog2_v1` definition.
        ...
        xp_assert_close(
            log_encoding_CanonLog2_v1(xp_asarray(-0.1, xp=xp)),
            -0.155370131996824,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog2_v1(xp_asarray(0.0, xp=xp)),
            0.092864125247312,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog2_v1(xp_asarray(0.18, xp=xp)),
            0.398254694983167,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog2_v1(xp_asarray(0.18, xp=xp), 12),
            0.397962933301861,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog2_v1(xp_asarray(0.18, xp=xp), 10, False),
            0.392025745397009,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog2_v1(xp_asarray(0.18, xp=xp), 10, False, False),
            0.379864582222983,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog2_v1(xp_asarray(1.0, xp=xp)),
            0.573229282897641,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
log_encoding_CanonLog2_v1` definition n-dimensional arrays support.
        ...
        x = 0.18
        clog2 = np.asarray(log_encoding_CanonLog2_v1(xp_asarray(x, xp=xp)))

        x = xp.tile(xp_asarray(x, xp=xp), (6,))
        clog2 = xp.tile(xp_asarray(clog2, xp=xp), (6,))
        xp_assert_close(
        ...
        x = xp_reshape(xp_asarray(x, xp=xp), (2, 3), xp=xp)
        clog2 = xp_reshape(xp_asarray(clog2, xp=xp), (2, 3), xp=xp)
        xp_assert_close(
            log_encoding_CanonLog2_v1(x),
            clog2,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        ...
        x = xp_reshape(xp_asarray(x, xp=xp), (2, 3, 1), xp=xp)
        clog2 = xp_reshape(xp_asarray(clog2, xp=xp), (2, 3, 1), xp=xp)
        xp_assert_close(
            log_encoding_CanonLog2_v1(x),
            clog2,
            atol=TOLERANCE_ABSOLUTE_TESTS,
...
log_encoding_CanonLog2_v1` definition domain and range scale support.
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    log_encoding_CanonLog2_v1(xp_asarray(x * factor, xp=xp)),
                    clog2 * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
log_decoding_CanonLog2_v1` definition.
        ...
        xp_assert_close(
            log_decoding_CanonLog2_v1(xp_asarray(-0.155370131996824, xp=xp)),
            -0.1,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog2_v1(xp_asarray(0.092864125247312, xp=xp)),
            0.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog2_v1(xp_asarray(0.398254694983167, xp=xp)),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog2_v1(xp_asarray(0.397962933301861, xp=xp), 12),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog2_v1(xp_asarray(0.392025745397009, xp=xp), 10, False),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog2_v1(
                xp_asarray(0.379864582222983, xp=xp), 10, False, False
            ),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog2_v1(xp_asarray(0.573229282897641, xp=xp)),
            1.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
log_decoding_CanonLog2_v1` definition n-dimensional arrays support.
        ...
        x = np.asarray(log_decoding_CanonLog2_v1(xp_asarray(clog2, xp=xp)))
...
log_decoding_CanonLog2_v1` definition domain and range scale support.
        ...
        x = np.asarray(log_decoding_CanonLog2_v1(xp_asarray(clog, xp=xp)))

        d_r = (("reference", 1), ("1", 1), ("100", 100))
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    log_decoding_CanonLog2_v1(xp_asarray(clog * factor, xp=xp)),
                    x * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
log_encoding_CanonLog2_v1_2` definition.
        ...
        xp_assert_close(
            log_encoding_CanonLog2_v1_2(xp_asarray(-0.1, xp=xp)),
            -0.155370130476722,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog2_v1_2(xp_asarray(0.0, xp=xp)),
            0.092864125000000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog2_v1_2(xp_asarray(0.18, xp=xp)),
            0.398254692561492,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog2_v1_2(xp_asarray(0.18, xp=xp), 12),
            0.398254692561492,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog2_v1_2(xp_asarray(0.18, xp=xp), 10, False),
            0.392025742568957,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog2_v1_2(xp_asarray(0.18, xp=xp), 10, False, False),
            0.379864579481518,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog2_v1_2(xp_asarray(1.0, xp=xp)),
            0.573229279230156,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_encoding_CanonLog2_v1(xp_asarray(samples, xp=xp)),
            np.asarray(log_encoding_CanonLog2_v1_2(xp_asarray(samples, xp=xp))),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_encoding_CanonLog2_v1(xp_asarray(samples, xp=xp), in_reflection=False),
            np.asarray(
                log_encoding_CanonLog2_v1_2(
                    xp_asarray(samples, xp=xp), in_reflection=False
                )
...
log_encoding_CanonLog2_v1_2` definition n-dimensional arrays support.
        ...
        x = 0.18
        clog2 = np.asarray(log_encoding_CanonLog2_v1_2(xp_asarray(x, xp=xp)))
...
log_encoding_CanonLog2_v1_2` definition domain and range scale support.
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    log_encoding_CanonLog2_v1_2(xp_asarray(x * factor, xp=xp)),
                    clog2 * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
log_decoding_CanonLog2_v1_2` definition.
        ...
        xp_assert_close(
            log_decoding_CanonLog2_v1_2(xp_asarray(-0.155370130476722, xp=xp)),
            -0.1,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog2_v1_2(xp_asarray(0.092864125000000, xp=xp)),
            0.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog2_v1_2(xp_asarray(0.398254692561492, xp=xp)),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog2_v1_2(xp_asarray(0.398254692561492, xp=xp), 12),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog2_v1_2(
                xp_asarray(0.392025742568957, xp=xp), 10, False
            ),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog2_v1_2(
                xp_asarray(0.379864579481518, xp=xp), 10, False, False
            ),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog2_v1_2(xp_asarray(0.573229279230156, xp=xp)),
            1.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
log_decoding_CanonLog2_v1_2` definition n-dimensional arrays support.
        ...
        x = np.asarray(log_decoding_CanonLog2_v1_2(xp_asarray(clog2, xp=xp)))
...
log_decoding_CanonLog2_v1_2` definition domain and range scale support.
        ...
        x = np.asarray(log_decoding_CanonLog2_v1_2(xp_asarray(clog, xp=xp)))

        d_r = (("reference", 1), ("1", 1), ("100", 100))
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    log_decoding_CanonLog2_v1_2(xp_asarray(clog * factor, xp=xp)),
                    x * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
log_encoding_CanonLog3_v1` definition.
        ...
        xp_assert_close(
            log_encoding_CanonLog3_v1(xp_asarray(-0.1, xp=xp)),
            -0.028494506076432,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog3_v1(xp_asarray(0.0, xp=xp)),
            0.125122189869013,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog3_v1(xp_asarray(0.18, xp=xp)),
            0.343389369388687,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog3_v1(xp_asarray(0.18, xp=xp), 12),
            0.343137802085105,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog3_v1(xp_asarray(0.18, xp=xp), 10, False),
            0.327953567219893,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog3_v1(xp_asarray(0.18, xp=xp), 10, False, False),
            0.313436005886328,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog3_v1(xp_asarray(1.0, xp=xp)),
            0.580277796238604,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
log_encoding_CanonLog3_v1` definition n-dimensional arrays support.
        ...
        x = 0.18
        clog3 = np.asarray(log_encoding_CanonLog3_v1(xp_asarray(x, xp=xp)))

        x = xp.tile(xp_asarray(x, xp=xp), (6,))
        clog3 = xp.tile(xp_asarray(clog3, xp=xp), (6,))
        xp_assert_close(
        ...
        x = xp_reshape(xp_asarray(x, xp=xp), (2, 3), xp=xp)
        clog3 = xp_reshape(xp_asarray(clog3, xp=xp), (2, 3), xp=xp)
        xp_assert_close(
            log_encoding_CanonLog3_v1(x),
            clog3,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        ...
        x = xp_reshape(xp_asarray(x, xp=xp), (2, 3, 1), xp=xp)
        clog3 = xp_reshape(xp_asarray(clog3, xp=xp), (2, 3, 1), xp=xp)
        xp_assert_close(
            log_encoding_CanonLog3_v1(x),
            clog3,
            atol=TOLERANCE_ABSOLUTE_TESTS,
...
log_encoding_CanonLog3_v1` definition domain and range scale support.
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    log_encoding_CanonLog3_v1(xp_asarray(x * factor, xp=xp)),
                    clog3 * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
log_decoding_CanonLog3_v1` definition.
        ...
        xp_assert_close(
            log_decoding_CanonLog3_v1(xp_asarray(-0.028494506076432, xp=xp)),
            -0.1,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog3_v1(xp_asarray(0.125122189869013, xp=xp)),
            0.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog3_v1(xp_asarray(0.343389369388687, xp=xp)),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog3_v1(xp_asarray(0.343137802085105, xp=xp), 12),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog3_v1(xp_asarray(0.327953567219893, xp=xp), 10, False),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog3_v1(
                xp_asarray(0.313436005886328, xp=xp), 10, False, False
            ),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog3_v1(xp_asarray(0.580277796238604, xp=xp)),
            1.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
log_decoding_CanonLog3_v1` definition n-dimensional arrays support.
        ...
        x = np.asarray(log_decoding_CanonLog3_v1(xp_asarray(clog3, xp=xp)))
...
log_decoding_CanonLog3_v1` definition domain and range scale support.
        ...
        x = np.asarray(log_decoding_CanonLog3_v1(xp_asarray(clog, xp=xp)))

        d_r = (("reference", 1), ("1", 1), ("100", 100))
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    log_decoding_CanonLog3_v1(xp_asarray(clog * factor, xp=xp)),
                    x * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
log_encoding_CanonLog3_v1_2` definition.
        ...
        xp_assert_close(
            log_encoding_CanonLog3_v1_2(xp_asarray(-0.1, xp=xp)),
            -0.028494507620494,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog3_v1_2(xp_asarray(0.0, xp=xp)),
            0.125122189999999,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog3_v1_2(xp_asarray(0.18, xp=xp)),
            0.343389370373936,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog3_v1_2(xp_asarray(0.18, xp=xp), 12),
            0.343389370373936,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog3_v1_2(xp_asarray(0.18, xp=xp), 10, False),
            0.327953568370475,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog3_v1_2(xp_asarray(0.18, xp=xp), 10, False, False),
            0.313436007221221,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_encoding_CanonLog3_v1_2(xp_asarray(1.0, xp=xp)),
            0.580277794216371,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_encoding_CanonLog3_v1(xp_asarray(samples, xp=xp)),
            np.asarray(log_encoding_CanonLog3_v1_2(xp_asarray(samples, xp=xp))),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_encoding_CanonLog3_v1(xp_asarray(samples, xp=xp), in_reflection=False),
            np.asarray(
                log_encoding_CanonLog3_v1_2(
                    xp_asarray(samples, xp=xp), in_reflection=False
                )
...
log_encoding_CanonLog3_v1_2` definition n-dimensional arrays support.
        ...
        x = 0.18
        clog3 = np.asarray(log_encoding_CanonLog3_v1_2(xp_asarray(x, xp=xp)))
...
log_encoding_CanonLog3_v1_2` definition domain and range scale support.
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    log_encoding_CanonLog3_v1_2(xp_asarray(x * factor, xp=xp)),
                    clog3 * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
...
log_decoding_CanonLog3_v1_2` definition.
        ...
        xp_assert_close(
            log_decoding_CanonLog3_v1_2(xp_asarray(-0.028494507620494, xp=xp)),
            -0.1,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog3_v1_2(xp_asarray(0.125122189999999, xp=xp)),
            0.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog3_v1_2(xp_asarray(0.343389370373936, xp=xp)),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            log_decoding_CanonLog3_v1_2(xp_asarray(0.343389370373936, xp=xp), 12),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog3_v1_2(
                xp_asarray(0.327953568370475, xp=xp), 10, False
            ),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog3_v1_2(
                xp_asarray(0.313436007221221, xp=xp), 10, False, False
            ),
            0.18,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog3_v1_2(xp_asarray(0.580277794216371, xp=xp)),
            1.0,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog3_v1(xp_asarray(samples, xp=xp)),
            np.asarray(log_decoding_CanonLog3_v1_2(xp_asarray(samples, xp=xp))),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            log_decoding_CanonLog3_v1(xp_asarray(samples, xp=xp), out_reflection=False),
            np.asarray(
                log_decoding_CanonLog3_v1_2(
                    xp_asarray(samples, xp=xp), out_reflection=False
                )
...
log_decoding_CanonLog3_v1_2` definition n-dimensional arrays support.
        ...
        x = np.asarray(log_decoding_CanonLog3_v1_2(xp_asarray(clog3, xp=xp)))
...
log_decoding_CanonLog3_v1_2` definition domain and range scale support.
        ...
        x = np.asarray(log_decoding_CanonLog3_v1_2(xp_asarray(clog, xp=xp)))

        d_r = (("reference", 1), ("1", 1), ("100", 100))
        for scale, factor in d_r:
            with domain_range_scale(scale):
                xp_assert_close(
                    log_decoding_CanonLog3_v1_2(xp_asarray(clog * factor, xp=xp)),
                    x * factor,
                    atol=TOLERANCE_ABSOLUTE_TESTS,
                )
