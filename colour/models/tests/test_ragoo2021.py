...
class TestXYZ_to_IPT_Ragoo2021:
    ...
    def test_n_dimensional_XYZ_to_IPT_Ragoo2021(self, xp: ModuleType) -> None:
        ...
        IPT = np.asarray(XYZ_to_IPT_Ragoo2021(XYZ))
...
class TestIPT_Ragoo2021_to_XYZ:
    ...
    def test_IPT_Ragoo2021_to_XYZ(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            IPT_Ragoo2021_to_XYZ(
                xp_asarray([0.42248243, 0.29105140, 0.20410663], xp=xp)
            ),
        ...
        xp_assert_close(
            IPT_Ragoo2021_to_XYZ(
                xp_asarray([0.54745257, -0.22795249, 0.10109646], xp=xp)
            ),
        ...
        xp_assert_close(
            IPT_Ragoo2021_to_XYZ(
                xp_asarray([0.32151337, 0.06071424, -0.27388774], xp=xp)
            ),
    ...
    def test_n_dimensional_IPT_Ragoo2021_to_XYZ(self, xp: ModuleType) -> None:
        ...
        IPT = xp_asarray([0.42248243, 0.29105140, 0.20410663], xp=xp)
        XYZ = np.asarray(IPT_Ragoo2021_to_XYZ(IPT))
