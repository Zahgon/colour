...
def Lab_to_DIN99(
    ...
    *Cui et al. (2002)*.
    ...
    cos_c = xp.cos(xp_asarray(xp_radians(c_3), xp=xp, like=L))
    sin_c = xp.sin(xp_asarray(xp_radians(c_3), xp=xp, like=L))
...
def DIN99_to_Lab(
    ...
    cos = xp.cos(xp_asarray(xp_radians(c_3), xp=xp, like=L_99))
    sin = xp.sin(xp_asarray(xp_radians(c_3), xp=xp, like=L_99))
