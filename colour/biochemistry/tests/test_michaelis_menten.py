...
reaction_rate_MichaelisMenten_Michaelis1913` definition.
        ...
        xp_assert_close(
            reaction_rate_MichaelisMenten_Michaelis1913(
                xp_asarray([0.25], xp=xp),
                xp_asarray([0.5], xp=xp),
                xp_asarray([0.25], xp=xp),
            ),
            np.array([0.250000000000000]),
        ...
        xp_assert_close(
            ...
            np.array([0.333333333333333]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            reaction_rate_MichaelisMenten_Michaelis1913(
                xp_asarray([0.65], xp=xp),
                xp_asarray([0.75], xp=xp),
                xp_asarray([0.35], xp=xp),
            ),
            np.array([0.487500000000000]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
reaction_rate_MichaelisMenten_Michaelis1913` definition n-dimensional arrays
        ...
        V_max = 0.5
        K_m = 0.25
        S = np.asarray(reaction_rate_MichaelisMenten_Michaelis1913(v, V_max, K_m))
        ...
        V_max = xp.tile(xp_asarray(V_max, xp=xp), (6, 1))
        K_m = xp.tile(xp_asarray(K_m, xp=xp), (6, 1))
        xp_assert_close(
            reaction_rate_MichaelisMenten_Michaelis1913(v, V_max, K_m),
            S,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        ...
        V_max = xp_reshape(xp_asarray(V_max, xp=xp), (2, 3, 1), xp=xp)
        K_m = xp_reshape(xp_asarray(K_m, xp=xp), (2, 3, 1), xp=xp)
        S = xp_reshape(xp_asarray(S, xp=xp), (2, 3, 1), xp=xp)
        xp_assert_close(
            reaction_rate_MichaelisMenten_Michaelis1913(v, V_max, K_m),
            S,
            atol=TOLERANCE_ABSOLUTE_TESTS,
...
substrate_concentration_MichaelisMenten_Michaelis1913` definition.
        ...
        xp_assert_close(
            substrate_concentration_MichaelisMenten_Michaelis1913(
                xp_asarray([1 / 3], xp=xp),
                xp_asarray([0.5], xp=xp),
                xp_asarray([0.25], xp=xp),
            ),
            np.array([0.500000000000000]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            substrate_concentration_MichaelisMenten_Michaelis1913(
                xp_asarray([0.4875], xp=xp),
                xp_asarray([0.75], xp=xp),
                xp_asarray([0.35], xp=xp),
            ),
            np.array([0.650000000000000]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
reaction_rate_MichaelisMenten_Abebe2017` definition n-dimensional arrays
        ...
        K_m = 0.25
        b_m = 0.25
        S = np.asarray(reaction_rate_MichaelisMenten_Abebe2017(v, V_max, K_m, b_m))
        ...
        V_max = xp.tile(xp_asarray(V_max, xp=xp), (6, 1))
        K_m = xp.tile(xp_asarray(K_m, xp=xp), (6, 1))
        b_m = xp.tile(xp_asarray(b_m, xp=xp), (6, 1))
        xp_assert_close(
            reaction_rate_MichaelisMenten_Abebe2017(v, V_max, K_m, b_m),
            S,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        ...
        V_max = xp_reshape(xp_asarray(V_max, xp=xp), (2, 3, 1), xp=xp)
        K_m = xp_reshape(xp_asarray(K_m, xp=xp), (2, 3, 1), xp=xp)
        b_m = xp_reshape(xp_asarray(b_m, xp=xp), (2, 3, 1), xp=xp)
        S = xp_reshape(xp_asarray(S, xp=xp), (2, 3, 1), xp=xp)
        xp_assert_close(
            reaction_rate_MichaelisMenten_Abebe2017(v, V_max, K_m, b_m),
            S,
...
substrate_concentration_MichaelisMenten_Abebe2017` definition.
        ...
        xp_assert_close(
            substrate_concentration_MichaelisMenten_Abebe2017(
                xp_asarray([0.400000000000000], xp=xp),
                xp_asarray([0.5], xp=xp),
                xp_asarray([0.25], xp=xp),
                xp_asarray([0.25], xp=xp),
            ),
        ...
        xp_assert_close(
            substrate_concentration_MichaelisMenten_Abebe2017(
                xp_asarray([0.666666666666666], xp=xp),
                xp_asarray([0.5], xp=xp),
                xp_asarray([0.25], xp=xp),
                xp_asarray([0.25], xp=xp),
            ),
        ...
        xp_assert_close(
            substrate_concentration_MichaelisMenten_Abebe2017(
                xp_asarray([0.951219512195122], xp=xp),
                xp_asarray([0.75], xp=xp),
                xp_asarray([0.35], xp=xp),
                xp_asarray([0.25], xp=xp),
            ),
...
reaction_rate_MichaelisMenten` wrapper definition.
        ...
        xp_assert_close(
            reaction_rate_MichaelisMenten(
                ...
                xp_asarray([0.8], xp=xp),
            ),
            np.array([0.961538461538461]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
