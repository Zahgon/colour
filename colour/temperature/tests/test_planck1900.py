...
class TestUv_to_CCT_Planck1900:
    ...
    def test_uv_to_CCT_Planck1900(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            uv_to_CCT_Planck1900(
                xp_asarray([0.225109670227493, 0.334387366663923], xp=xp),
        ...
        xp_assert_close(
            uv_to_CCT_Planck1900(
                xp_asarray([0.198126929048352, 0.307025980523306], xp=xp),
                optimisation_kwargs={"method": "Nelder-Mead"},
            ),
            7000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        ...
        xp_assert_close(
            uv_to_CCT_Planck1900(
                xp_asarray([0.182932683590136, 0.274073232217536], xp=xp),
                optimisation_kwargs={"method": "Nelder-Mead"},
            ),
            25000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
    ...
    def test_n_dimensional_uv_to_CCT_Planck1900(self, xp: ModuleType) -> None:
        ...
        uv = xp_asarray([0.225109670227493, 0.334387366663923], xp=xp)
        CCT = np.asarray(uv_to_CCT_Planck1900(uv))
...
class TestCCT_to_uv_Planck1900:
    ...
    def test_CCT_to_uv_Planck1900(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            CCT_to_uv_Planck1900(xp_asarray([4000], xp=xp)),
            np.array([[0.225109670227493, 0.334387366663923]]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            CCT_to_uv_Planck1900(xp_asarray([7000], xp=xp)),
            np.array([[0.198126929048352, 0.307025980523306]]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            CCT_to_uv_Planck1900(xp_asarray([25000], xp=xp)),
    ...
    def test_n_dimensional_CCT_to_uv_Planck1900(self, xp: ModuleType) -> None:
        ...
        CCT = 4000
        uv = np.asarray(CCT_to_uv_Planck1900(CCT))
