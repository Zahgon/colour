...
matrix_anomalous_trichromacy_Machado2009` definition.
        ...
        xp_assert_close(
            matrix_anomalous_trichromacy_Machado2009(
                cmfs, primaries, xp_asarray([0, 0, 0], xp=xp)
            ),
            np.identity(3),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            matrix_anomalous_trichromacy_Machado2009(
                cmfs, primaries, xp_asarray([2, 0, 0], xp=xp)
            ),
        ...
        xp_assert_close(
            matrix_anomalous_trichromacy_Machado2009(
                cmfs, primaries, xp_asarray([10, 0, 0], xp=xp)
            ),
        ...
        xp_assert_close(
            matrix_anomalous_trichromacy_Machado2009(
                cmfs, primaries, xp_asarray([20, 0, 0], xp=xp)
            ),
        ...
        xp_assert_close(
            matrix_anomalous_trichromacy_Machado2009(
                cmfs, primaries, xp_asarray([0, 2, 0], xp=xp)
            ),
        ...
        xp_assert_close(
            matrix_anomalous_trichromacy_Machado2009(
                cmfs, primaries, xp_asarray([0, 10, 0], xp=xp)
            ),
        ...
        xp_assert_close(
            matrix_anomalous_trichromacy_Machado2009(
                cmfs, primaries, xp_asarray([0, 20, 0], xp=xp)
            ),
        ...
        xp_assert_close(
            matrix_anomalous_trichromacy_Machado2009(
                cmfs, primaries, xp_asarray([0, 0, 5.00056688094503], xp=xp)
            ),
        ...
        xp_assert_close(
            matrix_anomalous_trichromacy_Machado2009(
                cmfs, primaries, xp_asarray([0, 0, 29.002939088780934], xp=xp)
            ),
        ...
        xp_assert_close(
            matrix_anomalous_trichromacy_Machado2009(
                cmfs, primaries, xp_asarray([0, 0, 59.00590434857581], xp=xp)
            ),
