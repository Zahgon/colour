...
RGB_2_degree_cmfs_to_XYZ_2_degree_cmfs` definition n-dimensional arrays
        ...
        wl = 700
        XYZ = np.asarray(RGB_2_degree_cmfs_to_XYZ_2_degree_cmfs(wl))
...
RGB_10_degree_cmfs_to_XYZ_10_degree_cmfs` definition n-dimensional arrays
        ...
        wl = 700
        XYZ = np.asarray(RGB_10_degree_cmfs_to_XYZ_10_degree_cmfs(wl))
...
RGB_10_degree_cmfs_to_LMS_10_degree_cmfs` definition n-dimensional arrays
        ...
        wl = 700
        LMS = np.asarray(RGB_10_degree_cmfs_to_LMS_10_degree_cmfs(wl))
        ...
        wl = xp_reshape(xp_asarray(wl, xp=xp), (2, 3, 1), xp=xp)
        LMS = xp_reshape(xp_asarray(LMS, xp=xp), (2, 3, 1, 3), xp=xp)
        xp_assert_close(
            RGB_10_degree_cmfs_to_LMS_10_degree_cmfs(wl),
            LMS,
            atol=TOLERANCE_ABSOLUTE_TESTS,
...
LMS_2_degree_cmfs_to_XYZ_2_degree_cmfs` definition n-dimensional arrays
        ...
        wl = 700
        XYZ = np.asarray(LMS_2_degree_cmfs_to_XYZ_2_degree_cmfs(wl))
...
LMS_10_degree_cmfs_to_XYZ_10_degree_cmfs` definition n-dimensional arrays
        ...
        wl = 700
        XYZ = np.asarray(LMS_10_degree_cmfs_to_XYZ_10_degree_cmfs(wl))
