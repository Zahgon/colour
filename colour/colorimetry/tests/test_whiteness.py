...
class TestWhitenessBerger1959:
    ...
    def test_whiteness_Berger1959(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            whiteness_Berger1959(
                xp_asarray([95.00000000, 100.00000000, 105.00000000], xp=xp),
                xp_asarray([94.80966767, 100.00000000, 107.30513595], xp=xp),
            ),
            30.36380179,
        ...
        xp_assert_close(
            whiteness_Berger1959(
                xp_asarray([105.00000000, 100.00000000, 95.00000000], xp=xp),
                xp_asarray([94.80966767, 100.00000000, 107.30513595], xp=xp),
            ),
            5.530469280673941,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        ...
        xp_assert_close(
            whiteness_Berger1959(
                xp_asarray([100.00000000, 100.00000000, 100.00000000], xp=xp),
                xp_asarray([100.00000000, 100.00000000, 100.00000000], xp=xp),
            ),
            33.300000000000011,
            atol=TOLERANCE_ABSOLUTE_TESTS,
    ...
    def test_n_dimensional_whiteness_Berger1959(self, xp: ModuleType) -> None:
        ...
        XYZ = xp_asarray([95.00000000, 100.00000000, 105.00000000], xp=xp)
        XYZ_0 = xp_asarray([94.80966767, 100.00000000, 107.30513595], xp=xp)
        W = np.asarray(whiteness_Berger1959(XYZ, XYZ_0))

        XYZ = xp.tile(xp_asarray(XYZ, xp=xp), (6, 1))
        XYZ_0 = xp.tile(xp_asarray(XYZ_0, xp=xp), (6, 1))
        ...
        XYZ_0 = xp_reshape(xp_asarray(XYZ_0, xp=xp), (2, 3, 3), xp=xp)
...
class TestWhitenessTaube1960:
    ...
    def test_n_dimensional_whiteness_Taube1960(self, xp: ModuleType) -> None:
        ...
        XYZ = xp_asarray([95.00000000, 100.00000000, 105.00000000], xp=xp)
        XYZ_0 = xp_asarray([94.80966767, 100.00000000, 107.30513595], xp=xp)
        WI = np.asarray(whiteness_Taube1960(XYZ, XYZ_0))

        XYZ = xp.tile(xp_asarray(XYZ, xp=xp), (6, 1))
        XYZ_0 = xp.tile(xp_asarray(XYZ_0, xp=xp), (6, 1))
        WI = xp.tile(xp_asarray(WI, xp=xp), (6,))
        xp_assert_close(
        ...
        XYZ = xp_reshape(xp_asarray(XYZ, xp=xp), (2, 3, 3), xp=xp)
        XYZ_0 = xp_reshape(xp_asarray(XYZ_0, xp=xp), (2, 3, 3), xp=xp)
        WI = xp_reshape(xp_asarray(WI, xp=xp), (2, 3), xp=xp)
        xp_assert_close(
            whiteness_Taube1960(XYZ, XYZ_0),
            WI,
            atol=TOLERANCE_ABSOLUTE_TESTS,
...
class TestWhitenessStensby1968:
    ...
    def test_whiteness_Stensby1968(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            whiteness_Stensby1968(
                xp_asarray([100.00000000, -2.46875131, -16.72486654], xp=xp)
            ),
            142.76834569,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            whiteness_Stensby1968(
                xp_asarray([100.00000000, 14.40943727, -9.61394885], xp=xp)
            ),
            172.07015836,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            whiteness_Stensby1968(xp_asarray([1, 1, 1], xp=xp)),
            1.00000000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
    ...
    def test_n_dimensional_whiteness_Stensby1968(self, xp: ModuleType) -> None:
        ...
        Lab = xp_asarray([100.00000000, -2.46875131, -16.72486654], xp=xp)
        WI = np.asarray(whiteness_Stensby1968(Lab))
...
class TestWhitenessASTM313:
    ...
    def test_n_dimensional_whiteness_ASTME313(self, xp: ModuleType) -> None:
        ...
        XYZ = xp_asarray([95.00000000, 100.00000000, 105.00000000], xp=xp)
        WI = np.asarray(whiteness_ASTME313(XYZ))
...
class TestWhitenessGanz1979:
    ...
    def test_whiteness_Ganz1979(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            whiteness_Ganz1979(xp_asarray([0.3139, 0.3311], xp=xp), 100),
            np.array([99.33176520, 1.76108290]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            whiteness_Ganz1979(xp_asarray([0.3500, 0.3334], xp=xp), 100),
            np.array([23.38525400, -32.66182560]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            whiteness_Ganz1979(xp_asarray([0.3334, 0.3334], xp=xp), 100),
    ...
    def test_n_dimensional_whiteness_Ganz1979(self, xp: ModuleType) -> None:
        ...
        xy = xp_asarray([0.3167, 0.3334], xp=xp)
        Y = 100
        WT = np.asarray(whiteness_Ganz1979(xy, Y))

        xy = xp.tile(xp_asarray(xy, xp=xp), (6, 1))
        WT = xp.tile(xp_asarray(WT, xp=xp), (6, 1))
        xp_assert_close(
        ...
        WT = xp_reshape(xp_asarray(WT, xp=xp), (2, 3, 2), xp=xp)
        xp_assert_close(
            whiteness_Ganz1979(xy, Y),
            WT,
            atol=TOLERANCE_ABSOLUTE_TESTS,
...
class TestWhitenessCIE2004:
    ...
    def test_whiteness_CIE2004(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            whiteness_CIE2004(
                xp_asarray([0.3139, 0.3311], xp=xp),
                100,
                xp_asarray([0.3139, 0.3311], xp=xp),
            ),
        ...
        xp_assert_close(
            whiteness_CIE2004(
                xp_asarray([0.3500, 0.3334], xp=xp),
                100,
                xp_asarray([0.3139, 0.3311], xp=xp),
            ),
        ...
        xp_assert_close(
            whiteness_CIE2004(
                xp_asarray([0.3334, 0.3334], xp=xp),
                100,
                xp_asarray([0.3139, 0.3311], xp=xp),
            ),
    ...
    def test_n_dimensional_whiteness_CIE2004(self, xp: ModuleType) -> None:
        ...
        xy = xp_asarray([0.3167, 0.3334], xp=xp)
        Y = 100
        xy_n = xp_asarray([0.3139, 0.3311], xp=xp)
        WT = np.asarray(whiteness_CIE2004(xy, Y, xy_n))
        ...
        Y = xp.tile(xp_asarray(Y, xp=xp), (6,))
        xy_n = xp.tile(xp_asarray(xy_n, xp=xp), (6, 1))
        xp_assert_close(
            whiteness_CIE2004(xy, Y, xy_n),
            WT,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        ...
        xy = xp_reshape(xp_asarray(xy, xp=xp), (2, 3, 2), xp=xp)
        Y = xp_reshape(xp_asarray(Y, xp=xp), (2, 3), xp=xp)
        xy_n = xp_reshape(xp_asarray(xy_n, xp=xp), (2, 3, 2), xp=xp)
        WT = xp_reshape(xp_asarray(WT, xp=xp), (2, 3, 2), xp=xp)
        xp_assert_close(
            whiteness_CIE2004(xy, Y, xy_n),
            WT,
...
class TestWhiteness:
    ...
    def test_domain_range_scale_whiteness(self, xp: ModuleType) -> None:
        ...
        v = [np.asarray(whiteness(XYZ, XYZ_0, method)) for method in m]
