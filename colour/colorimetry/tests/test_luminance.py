...
class TestLuminanceNewhall1943:
    ...
    def test_luminance_Newhall1943(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            luminance_Newhall1943(xp_asarray([4.08244375], xp=xp)),
            12.550078816731881,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_Newhall1943(xp_asarray([5.39132685], xp=xp)),
            23.481252371310738,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_Newhall1943(xp_asarray([2.97619312], xp=xp)),
            6.4514266875601924,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
    ...
    def test_domain_range_scale_luminance_Newhall1943(self) -> None:
        ...
        Y = np.asarray(luminance_Newhall1943(4.08244375))
...
class TestLuminanceASTMD1535:
    ...
    def test_luminance_ASTMD1535(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            luminance_ASTMD1535(xp_asarray([4.08244375], xp=xp)),
            12.236342675366036,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_ASTMD1535(xp_asarray([5.39132685], xp=xp)),
            22.893999867280378,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_ASTMD1535(xp_asarray([2.97619312], xp=xp)),
            6.2902253509053132,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
    ...
    def test_domain_range_scale_luminance_ASTMD1535(self) -> None:
        ...
        Y = np.asarray(luminance_ASTMD1535(4.08244375))
...
intermediate_luminance_function_CIE1976` definition.
        ...
        xp_assert_close(
            intermediate_luminance_function_CIE1976(
                xp_asarray([0.495929964178047], xp=xp)
            ),
            12.197225350000002,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            intermediate_luminance_function_CIE1976(
                xp_asarray([0.613072093530391], xp=xp)
            ),
            23.042767810000004,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            intermediate_luminance_function_CIE1976(
                xp_asarray([0.394876333449113], xp=xp)
            ),
            6.157200790000001,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
intermediate_luminance_function_CIE1976` definition domain and range scale
        ...
        Y = np.asarray(intermediate_luminance_function_CIE1976(41.527875844653451, 100))
...
class TestLuminanceCIE1976:
    ...
    def test_luminance_CIE1976(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            luminance_CIE1976(xp_asarray([41.527875844653451], xp=xp)),
            12.197225350000002,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_CIE1976(xp_asarray([55.116362849525402], xp=xp)),
            23.042767810000004,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_CIE1976(xp_asarray([29.805654680097106], xp=xp)),
            6.157200790000001,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_CIE1976(xp_asarray([56.480581732417676], xp=xp), 50),
            12.197225349999998,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_CIE1976(xp_asarray([47.317620274162735], xp=xp), 75),
            12.197225350000002,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_CIE1976(xp_asarray([42.519930728120940], xp=xp), 95),
            12.197225350000005,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
    ...
    def test_domain_range_scale_luminance_CIE1976(self) -> None:
        ...
        Y = np.asarray(luminance_CIE1976(41.527875844653451, 100))
...
class TestLuminanceFairchild2010:
    ...
    def test_luminance_Fairchild2010(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            luminance_Fairchild2010(xp_asarray([31.996390226262736], xp=xp)),
            0.12197225350000002,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_Fairchild2010(xp_asarray([60.203153682783302], xp=xp)),
            0.23042767809999998,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_Fairchild2010(xp_asarray([11.836517240976489], xp=xp)),
            0.06157200790000001,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_Fairchild2010(xp_asarray([24.424283249379986], xp=xp), 2.75),
            0.12197225350000002,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_Fairchild2010(xp_asarray([100.019986327374240], xp=xp)),
            1008.00000024,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_Fairchild2010(xp_asarray([100.019999997090270], xp=xp)),
            100799.92312466,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
    ...
    def test_domain_range_scale_luminance_Fairchild2010(self) -> None:
        ...
        Y = np.asarray(luminance_Fairchild2010(31.996390226262736))
...
class TestLuminanceFairchild2011:
    ...
    def test_luminance_Fairchild2011(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            luminance_Fairchild2011(xp_asarray([51.852958445912506], xp=xp)),
            0.12197225350000007,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_Fairchild2011(xp_asarray([65.275207956353853], xp=xp)),
            0.23042767809999998,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_Fairchild2011(xp_asarray([39.818935510715917], xp=xp)),
            0.061572007900000038,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_Fairchild2011(xp_asarray([0.13268968410139345], xp=xp), 2.75),
            0.12197225350000002,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_Fairchild2011(xp_asarray([234.72925681957565], xp=xp)),
            1008.00000000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_Fairchild2011(xp_asarray([245.57059778237573], xp=xp)),
            100800.00000000,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
    ...
    def test_domain_range_scale_luminance_Fairchild2011(self) -> None:
        ...
        Y = np.asarray(luminance_Fairchild2011(26.459509817572265))
...
class TestLuminanceAbebe2017:
    ...
    def test_luminance_Abebe2017(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            luminance_Abebe2017(xp_asarray([0.486955571109229], xp=xp)),
            12.197225350000004,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            luminance_Abebe2017(
                xp_asarray([0.474544792145434], xp=xp), method="Stevens"
            ),
            12.197225350000025,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            luminance_Abebe2017(xp_asarray([0.286847428534793], xp=xp), 1000),
            12.197225350000046,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            luminance_Abebe2017(xp_asarray([0.192145492588158], xp=xp), 4000),
            12.197225350000121,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            luminance_Abebe2017(
                xp_asarray([0.170365211220992], xp=xp), 4000, method="Stevens"
            ),
            12.197225349999933,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
class TestLuminance:
    ...
    def test_domain_range_scale_luminance(self) -> None:
        ...
        v = [np.asarray(luminance(41.527875844653451, method, Y_n=100)) for method in m]
