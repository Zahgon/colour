...
from colour.utilities import metric_mse, metric_psnr, xp_asarray, xp_assert_close
...
class TestMetricMse:
    ...
    def test_metric_mse(self, xp: ModuleType) -> None:
        ...
        a = xp_asarray([0.48222001, 0.31654775, 0.22070353], xp=xp)
        assert np.asarray(metric_mse(a, a)) == 0
...
class TestMetricPsnr:
    ...
    def test_metric_psnr(self, xp: ModuleType) -> None:
        ...
        a = xp_asarray([0.48222001, 0.31654775, 0.22070353], xp=xp)
        assert np.asarray(metric_psnr(a, a)) == 0
