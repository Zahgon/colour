...
cartesian_to_spherical` definition.
        ...
        xp_assert_close(
            cartesian_to_spherical(xp_asarray([3, 1, 6], xp=xp)),
            np.array([6.78232998, 0.48504979, 0.32175055]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            cartesian_to_spherical(xp_asarray([-1, 9, 16], xp=xp)),
            np.array([18.38477631, 0.51501513, 1.68145355]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            cartesian_to_spherical(xp_asarray([6.3434, -0.9345, 18.5675], xp=xp)),
...
cartesian_to_spherical` definition n-dimensional arrays support.
        ...
        a_i = xp_asarray([3, 1, 6], xp=xp)
        a_o = np.asarray(cartesian_to_spherical(a_i))

        a_i = xp.tile(xp_asarray(a_i, xp=xp), (6, 1))
        a_o = xp.tile(xp_asarray(a_o, xp=xp), (6, 1))
        xp_assert_close(cartesian_to_spherical(a_i), a_o, atol=TOLERANCE_ABSOLUTE_TESTS)

        a_i = xp_reshape(xp_asarray(a_i, xp=xp), (2, 3, 3), xp=xp)
        a_o = xp_reshape(xp_asarray(a_o, xp=xp), (2, 3, 3), xp=xp)
        xp_assert_close(cartesian_to_spherical(a_i), a_o, atol=TOLERANCE_ABSOLUTE_TESTS)
...
spherical_to_cartesian` definition.
        ...
        xp_assert_close(
            spherical_to_cartesian(
                xp_asarray([6.78232998, 0.48504979, 0.32175055], xp=xp)
            ),
        ...
        xp_assert_close(
            spherical_to_cartesian(
                xp_asarray([18.38477631, 0.51501513, 1.68145355], xp=xp)
            ),
        ...
        xp_assert_close(
            spherical_to_cartesian(
                xp_asarray([19.64342307, 0.33250603, -0.14626640], xp=xp)
            ),
...
spherical_to_cartesian` definition n-dimensional arrays support.
        ...
        a_i = xp_asarray([6.78232998, 0.48504979, 0.32175055], xp=xp)
        a_o = np.asarray(spherical_to_cartesian(a_i))
...
cartesian_to_polar` definition.
        ...
        xp_assert_close(
            cartesian_to_polar(xp_asarray([3, 1], xp=xp)),
            np.array([3.16227766, 0.32175055]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            cartesian_to_polar(xp_asarray([-1, 9], xp=xp)),
            np.array([9.05538514, 1.68145355]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            cartesian_to_polar(xp_asarray([6.3434, -0.9345], xp=xp)),
...
cartesian_to_polar` definition n-dimensional arrays support.
        ...
        a_i = xp_asarray([3, 1], xp=xp)
        a_o = np.asarray(cartesian_to_polar(a_i))

        a_i = xp.tile(xp_asarray(a_i, xp=xp), (6, 1))
        a_o = xp.tile(xp_asarray(a_o, xp=xp), (6, 1))
        xp_assert_close(cartesian_to_polar(a_i), a_o, atol=TOLERANCE_ABSOLUTE_TESTS)

        a_i = xp_reshape(xp_asarray(a_i, xp=xp), (2, 3, 2), xp=xp)
        a_o = xp_reshape(xp_asarray(a_o, xp=xp), (2, 3, 2), xp=xp)
        xp_assert_close(cartesian_to_polar(a_i), a_o, atol=TOLERANCE_ABSOLUTE_TESTS)
...
polar_to_cartesian` definition.
        ...
        xp_assert_close(
            polar_to_cartesian(xp_asarray([0.32175055, 1.08574654], xp=xp)),
            np.array([0.15001697, 0.28463718]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            polar_to_cartesian(xp_asarray([1.68145355, 1.05578119], xp=xp)),
            np.array([0.82819662, 1.46334425]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            polar_to_cartesian(xp_asarray([-0.14626640, 1.23829030], xp=xp)),
...
polar_to_cartesian` definition n-dimensional arrays support.
        ...
        a_i = xp_asarray([3.16227766, 0.32175055], xp=xp)
        a_o = np.asarray(polar_to_cartesian(a_i))
...
cartesian_to_cylindrical` definition.
        ...
        xp_assert_close(
            cartesian_to_cylindrical(xp_asarray([3, 1, 6], xp=xp)),
            np.array([3.16227766, 0.32175055, 6.00000000]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            cartesian_to_cylindrical(xp_asarray([-1, 9, 16], xp=xp)),
            np.array([9.05538514, 1.68145355, 16.00000000]),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            cartesian_to_cylindrical(xp_asarray([6.3434, -0.9345, 18.5675], xp=xp)),
...
cartesian_to_cylindrical` definition n-dimensional arrays support.
        ...
        a_i = xp_asarray([3, 1, 6], xp=xp)
        a_o = np.asarray(cartesian_to_cylindrical(a_i))
...
cylindrical_to_cartesian` definition.
        ...
        xp_assert_close(
            cylindrical_to_cartesian(
                xp_asarray([0.32175055, 1.08574654, 6.78232998], xp=xp)
            ),
        ...
        xp_assert_close(
            cylindrical_to_cartesian(
                xp_asarray([1.68145355, 1.05578119, 18.38477631], xp=xp)
            ),
        ...
        xp_assert_close(
            cylindrical_to_cartesian(
                xp_asarray([-0.14626640, 1.23829030, 19.64342307], xp=xp)
            ),
...
cylindrical_to_cartesian` definition n-dimensional arrays support.
        ...
        a_i = xp_asarray([3.16227766, 0.32175055, 6.00000000], xp=xp)
        a_o = np.asarray(cylindrical_to_cartesian(a_i))
