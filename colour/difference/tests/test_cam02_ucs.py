...
class TestDelta_E_Luo2006:
    ...
    def test_delta_E_Luo2006(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            delta_E_Luo2006(
                xp_asarray([54.90433134, -0.08450395, -0.06854831], xp=xp),
                xp_asarray([54.80352754, -3.96940084, -13.57591013], xp=xp),
    ...
    def test_n_dimensional_delta_E_Luo2006(self, xp: ModuleType) -> None:
        ...
        Jpapbp_1 = xp_asarray([54.90433134, -0.08450395, -0.06854831], xp=xp)
        Jpapbp_2 = xp_asarray([54.80352754, -3.96940084, -13.57591013], xp=xp)
        ...
        Jpapbp_1 = xp.tile(xp_asarray(Jpapbp_1, xp=xp), (6, 1))
        Jpapbp_2 = xp.tile(xp_asarray(Jpapbp_2, xp=xp), (6, 1))
        delta_E_p = xp.tile(xp_asarray(delta_E_p, xp=xp), (6,))
        xp_assert_close(
        ...
        Jpapbp_1 = xp_reshape(xp_asarray(Jpapbp_1, xp=xp), (2, 3, 3), xp=xp)
        Jpapbp_2 = xp_reshape(xp_asarray(Jpapbp_2, xp=xp), (2, 3, 3), xp=xp)
        delta_E_p = xp_reshape(xp_asarray(delta_E_p, xp=xp), (2, 3), xp=xp)
        xp_assert_close(
            delta_E_Luo2006(Jpapbp_1, Jpapbp_2, COEFFICIENTS_UCS_LUO2006["CAM02-LCD"]),
            delta_E_p,
            atol=TOLERANCE_ABSOLUTE_TESTS,
