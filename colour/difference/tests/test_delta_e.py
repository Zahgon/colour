...
class TestDelta_E_CIE1976:
    ...
    def test_delta_E_CIE1976(self, xp: ModuleType) -> None:
        ...
        Lab_1 = xp_asarray([48.99183622, -0.10561667, 400.65619925], xp=xp)
        Lab_2 = xp_asarray([50.65907324, -0.11671910, 402.82235718], xp=xp)

        additional_data = delta_E_CIE1976(Lab_1, Lab_2, additional_data=True)

        Lab_1 = xp_reshape(xp.tile(xp_asarray(Lab_1, xp=xp), (6, 1)), (2, 3, 3), xp=xp)
        Lab_2 = xp_reshape(xp.tile(xp_asarray(Lab_2, xp=xp), (6, 1)), (2, 3, 3), xp=xp)

        xp_assert_close(
            delta_E_CIE1976(Lab_1, Lab_2),
            np.asarray(euclidean_distance(Lab_1, Lab_2)),
...
class TestDelta_E_CIE1994:
    ...
    def test_delta_E_CIE1994(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            delta_E_CIE1994(
                xp_asarray([48.99183622, -0.10561667, 400.65619925], xp=xp),
                xp_asarray([50.65907324, -0.11671910, 402.82235718], xp=xp),
            ),
            1.671119130541200,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
    ...
    def test_n_dimensional_delta_E_CIE1994(self, xp: ModuleType) -> None:
        ...
        Lab_1 = xp_asarray([48.99183622, -0.10561667, 400.65619925], xp=xp)
        Lab_2 = xp_asarray([50.65907324, -0.11671910, 402.82235718], xp=xp)
        delta_E = np.asarray(delta_E_CIE1994(Lab_1, Lab_2))
...
class TestDelta_E_CIE2000:
    ...
    def test_delta_E_CIE2000(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            delta_E_CIE2000(
                xp_asarray([100.00000000, 21.57210357, 272.22819350], xp=xp),
                xp_asarray([50.00000000, 426.67945353, 72.39590835], xp=xp),
                textiles=True,
            ),
            95.79205352,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        ...
        xp_assert_close(
            delta_E_CIE2000(
                xp_asarray([100.00000000, 21.57210357, 272.22819350], xp=xp),
                xp_asarray([50.00000000, 74.05216981, 276.45318193], xp=xp),
                textiles=True,
            ),
            23.55420943,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        ...
        xp_assert_close(
            delta_E_CIE2000(
                xp_asarray([100.00000000, 21.57210357, 272.22819350], xp=xp),
                xp_asarray([50.00000000, 8.32281957, -73.58297716], xp=xp),
                textiles=True,
            ),
            70.63213819,
            atol=TOLERANCE_ABSOLUTE_TESTS,
    ...
    def test_n_dimensional_delta_E_CIE2000(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            ...
            np.array(
                [np.full((2, 3), np.asarray(val)) for val in additional_data.values]
            ),
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
class TestDelta_E_ITP:
    ...
    def test_delta_E_ITP(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            delta_E_ITP(
                ...
                xp_asarray([0.4885468072, -0.04739350675, 0.07475401302], xp=xp),
                xp_asarray([0.4899203231, -0.04567508203, 0.07361341775], xp=xp),
            ),
            1.426572247,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            delta_E_ITP(
                ...
                xp_asarray([0.7538438727, 0, -6.25e-16], xp=xp),
                xp_asarray([0.7538912244, 0.001930922514, -0.0003599955951], xp=xp),
            ),
            0.7426668055,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            delta_E_ITP(
                # RGB: (0, 0, 0), 100% Black
                xp_asarray([0.1596179061, 0, -1.21e-16], xp=xp),
                xp_asarray([0.1603575152, 0.02881444889, -0.009908665843], xp=xp),
            ),
            12.60096264,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            delta_E_ITP(
                # RGB: (255, 0, 0), 100% Red
                xp_asarray([0.5965650331, -0.2083210482, 0.3699729716], xp=xp),
                xp_asarray([0.596263079, -0.1629742033, 0.3617767026], xp=xp),
            ),
            17.36012552,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            delta_E_ITP(
                ...
                xp_asarray([0.7055787513, -0.4063731514, -0.07278767382], xp=xp),
                xp_asarray([0.7046946082, -0.3771037586, -0.07141626753], xp=xp),
            ),
            10.60227327,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            delta_E_ITP(
                ...
                xp_asarray([0.5180652611, 0.2932420978, -0.1873112695], xp=xp),
                xp_asarray([0.5167090868, 0.298191609, -0.1824609953], xp=xp),
            ),
            4.040270489,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            delta_E_ITP(
                ...
                xp_asarray([0.7223275939, -0.01290632441, -0.1139004748], xp=xp),
                xp_asarray([0.7215329274, -0.007863821961, -0.1106683944], xp=xp),
            ),
            3.00633812,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            delta_E_ITP(
                ...
                xp_asarray([0.6401125212, 0.280225698, 0.1665590804], xp=xp),
                xp_asarray([0.640473651, 0.2819981563, 0.1654050172], xp=xp),
            ),
            1.07944277,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            delta_E_ITP(
                ...
                xp_asarray([0.7413041405, -0.3638807621, 0.04959414794], xp=xp),
                xp_asarray([0.7412815181, -0.3299076141, 0.04545287368], xp=xp),
            ),
            12.5885645,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
    ...
    def test_n_dimensional_delta_E_ITP(self, xp: ModuleType) -> None:
        ...
        ICtCp_1 = xp_asarray([0.4885468072, -0.04739350675, 0.07475401302], xp=xp)
        ICtCp_2 = xp_asarray([0.4899203231, -0.04567508203, 0.07361341775], xp=xp)
        delta_E = delta_E_ITP(ICtCp_1, ICtCp_2)
        additional_data = delta_E_ITP(ICtCp_1, ICtCp_2, additional_data=True)

        ICtCp_1 = xp.tile(xp_asarray(ICtCp_1, xp=xp), (6, 1))
        ICtCp_2 = xp.tile(xp_asarray(ICtCp_2, xp=xp), (6, 1))
        delta_E = xp.tile(xp_asarray(delta_E, xp=xp), (6,))
        xp_assert_close(
        ...
        ICtCp_1 = xp_reshape(xp_asarray(ICtCp_1, xp=xp), (2, 3, 3), xp=xp)
        ICtCp_2 = xp_reshape(xp_asarray(ICtCp_2, xp=xp), (2, 3, 3), xp=xp)
        delta_E = xp_reshape(xp_asarray(delta_E, xp=xp), (2, 3), xp=xp)
        xp_assert_close(
            delta_E_ITP(ICtCp_1, ICtCp_2), delta_E, atol=TOLERANCE_ABSOLUTE_TESTS
        )
...
class TestDelta_E_HyAB:
    ...
    def test_delta_E_HyAB(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            delta_E_HyAB(
                xp_asarray([39.91531343, 51.16658481, 146.12933781], xp=xp),
                xp_asarray([53.12207516, -39.92365056, 249.54831278], xp=xp),
            ),
            151.021548177635900,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            delta_E_HyAB(
                xp_asarray([39.91531343, 51.16658481, 146.12933781], xp=xp),
                xp_asarray([28.52234779, 19.46628874, 472.06042624], xp=xp),
            ),
            338.862022462305200,
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
    ...
    def test_domain_range_scale_delta_E_HyAB(self, xp: ModuleType) -> None:
        ...
        Lab_1 = xp_asarray([39.91531343, 51.16658481, 146.12933781], xp=xp)
        Lab_2 = xp_asarray([53.12207516, -39.92365056, 249.54831278], xp=xp)
        delta_E = delta_E_HyAB(Lab_1, Lab_2)
        additional_data = delta_E_HyAB(Lab_1, Lab_2, additional_data=True)
